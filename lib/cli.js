...
var MmsSnap = require('./mms-snapshoot.js');
...
cli.parse({
	...
	dest: [false, 'Destination path', 'path', './']
});

cli.main(function(args, options) {
	var self = this;
	var mmsSnap = new MmsSnap(options.log, options.key, options.group, options.replicaSetName, options.snapshots, options.verbose, options.dest, function(err, data) {
		if (err) {
